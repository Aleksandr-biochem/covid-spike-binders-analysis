...
def rmsd_calc(mutant="", trj_path=".", outpth="."):
  """
  ...
  """
  #path_to_trj_dir = f"../../2_MD_Amber/sample/{mutant}/"
...
if __name__ == "__main__":
    # parse arguments
    parser = argparse.ArgumentParser(description='Calculate rmsd of complex per each ns of simulated trajectories and return in a csv format:')
    ...
    rmsd_calc(mutant=args.m[0], trj_path=args.i[0], outpth=args.o[0])
